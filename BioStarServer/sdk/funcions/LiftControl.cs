    ...
    public class LiftControl : FunctionModule
    {
        ...
        public void setLift(IntPtr sdkContext, uint deviceID, bool isMasterDevice)
        {
            ...
            if (Util.IsYes())
            {
                ...
                Array.Clear(lift.deviceID, 0, BS2Envirionment.BS2_MAX_DEVICES_ON_LIFT);
                Array.Clear(lift.floor, 0, BS2Envirionment.BS2_MAX_FLOORS_ON_LIFT);
                Array.Clear(lift.dualAuthApprovalGroupID, 0, BS2Envirionment.BS2_MAX_DUAL_AUTH_APPROVAL_GROUP_ON_LIFT);
                //Array.Clear(lift.alarm, 0, BS2Envirionment.BS2_MAX_ALARMS_ON_LIFT);
                ...
                Array.Clear(lift.name, 0, BS2Envirionment.BS2_MAX_LIFT_NAME_LEN);
            ...
            else 
            {
                ...
                for (int idx = 0; idx < amount; ++idx)
                {
                    ...
                    else if (liftName.Length > BS2Envirionment.BS2_MAX_LIFT_NAME_LEN)
                    {
                        Console.WriteLine("  Name of lift should less than {0} words.", BS2Envirionment.BS2_MAX_LIFT_NAME_LEN);
                        return;
                    }
                    else
                    {
                    ...
                    Console.WriteLine("  How many floors do you want to set? [0(default)-{0}]", BS2Envirionment.BS2_MAX_FLOORS_ON_LIFT);
                    Console.Write("  >>>> ");
                    ...
                    Console.WriteLine("  How many dualAuthApprovalGroups do you want to set? [0(default)-{0}]", BS2Envirionment.BS2_MAX_DUAL_AUTH_APPROVAL_GROUP_ON_LIFT);
                    Console.Write("  >>>> ");
                    ...
                    */
                    ...
                    Console.WriteLine("  How many alarms for this lift do you want to set? [0(default)-{0}]", BS2Envirionment.BS2_MAX_ALARMS_ON_LIFT);
                    Console.Write("  >>>> ");
        ...
        public void setFloorLevel(IntPtr sdkContext, uint deviceID, bool isMasterDevice)
        {
            ...
            for (int idx = 0; idx < amount; ++idx)
            {
                ...
                else if (floorName.Length > BS2Envirionment.BS2_MAX_FLOOR_LEVEL_NAME_LEN)
                {
                    Console.WriteLine("  Name of floor Level should less than {0} words.", BS2Envirionment.BS2_MAX_FLOOR_LEVEL_NAME_LEN);
                    return;
                }
                else
                {
                    byte[] floorLevelArray = Encoding.UTF8.GetBytes(floorName);
                    Array.Clear(floorLevel.name, 0, BS2Envirionment.BS2_MAX_FLOOR_LEVEL_NAME_LEN);
                    Array.Copy(floorLevelArray, floorLevel.name, floorLevelArray.Length);
                }

                Console.WriteLine("  How many floor schedules do you want to set? [0(default)-{0}]", BS2Envirionment.BS2_MAX_FLOOR_LEVEL_ITEMS);
                Console.Write("  >>>> ");
